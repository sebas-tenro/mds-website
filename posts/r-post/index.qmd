...
**Data source:** The flight data come from the [`nycflights23`](https://cran.r-project.org/package=nycflights23) R package (Ismay, Couch, & Wickham, 2025), licensed under CC0, which provides flight information for flights departing from New York City airports in 2023.
